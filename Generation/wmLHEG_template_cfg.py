...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIISummer15wmLHES-00000.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIISummer15wmLHES-00000_inLHE.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),
...
#---- randomize ----
import random
process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(12)
